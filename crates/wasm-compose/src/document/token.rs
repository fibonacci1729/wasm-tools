...
pub(super) fn rewrite_error(err: &mut anyhow::Error, file: &str, contents: &str) {
    ...
    let msg = super::error::highlight(pos as usize, None, file, contents, lex);
